...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      {
        signature: '@Remote(\'withdraw\') withdraw(agent: Agent, request: SessionRevisionRequest): Promise<SessionRevisionResult>',
        description: 'Withdraw an eligible prompt or finalized assistant message and its current suffix.',
        parameters: [{ name: 'agent', description: 'live top-level agent selected by the Remote lookup.' }, { name: 'request', description: 'target, compare-and-set tail, timezone, and effect acknowledgement.' }],
