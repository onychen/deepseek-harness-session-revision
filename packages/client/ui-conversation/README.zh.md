...
- **分支操作仍只位于 assistant 回答下方**：修订操作由 `dsh-client-ui-session-revision` 提供；若要保留可见旧版本，仍需在修订前创建分支（[决策](../../../.agents/notes/implemented/feature/2026-08-16-current-session-history-revision.md)）。
